...
!1;this.sortDir=this.sortBy=null;this.update()},destroy:function(){delete c[this.id];this.clear();this.$super()}},{lookupStore:function(a){return c[a]||null},eachStore:function(a,b){for(var e in c)if(!1===a.call(b,c[e]))break}})})();return t});
